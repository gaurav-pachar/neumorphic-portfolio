...
import { FaHome, FaFileAlt, FaPhoneAlt } from "react-icons/fa";
      ...
      <div className="mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 ">
        <div className="relative bg-primary shadow-protruding rounded-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden rounded-xl shadow-protruding bg-primary py-10 px-6 sm:px-10 xl:p-12">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-gray-500">
                  <FaPhoneAlt className="h-6 w-6 flex-shrink-0 text-gray-500" aria-hidden="true" />
                ...
                <dd className="flex text-base text-gray-500">
                  <IoMail className="h-6 w-6 flex-shrink-0 text-gray-500" aria-hidden="true" />
                  <span className="ml-3">support@workcation.com</span>
                </dd>
              </dl>
              <ul role="list" className="mt-8 flex space-x-12">
                <li>
                  <a className="text-gray-500 hover:text-indigo-100" href="#">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className="block w-full shadow-sunken rounded-md border-gray-300 py-3 px-4 text-gray-900 bg-primary focus:border-indigo-500 focus:ring-indigo-500"
                    />
                  </div>
                </div>
                <div>
