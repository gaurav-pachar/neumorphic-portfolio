      ...
      <main className={Classes.main}>
        <div className="h-full gap-4 flex md:hidden flex-col justify-between items-center py-2">
          ...
          <div id='text' className='text-center'>
            ...
            <p className='text-center text-gray-400 font-semibold md:hidden antialiased'>
              JavaScript | ReactJs | NextJs | Html | CSS | NodeJs | ExpressJs
            </p>
          </div>
          <div id='socialLink' className='w-full flex justify-center items-center'>
            <div className="flex mt-4 gap-4 shadow-protruding px-3 py-2 rounded-lg">
                <a className=''>
                <SvgElements name="linkedin"/>
                </a>
                <a className=''>
                <SvgElements name="github"/>
                </a>
            </div>
          </div>
        ...
        <div className='hidden md:flex justify-center items-center h-full w-full py-24'>
          ...
          <div className='w-2/4 p-6'>
            ...
            <div className="flex w-fit mt-4 mx-auto gap-4 shadow-protruding px-3 py-2 rounded-lg">
                <a className=''>
                <SvgElements name="linkedin"/>
                </a>
                <a className=''>
...
/*
<div className='md:flex md:justify-center md:items-center md:p-8'>
        <div>
        <div className='mx-auto w-4/5 flex justify-center items-center md:mt-20'>
          <PictureFrame ImageSrc={MyGif.src}/>
        </div>
        <div className='text-center'>
          ...
          <h3 className='font-bold text-gray-500 mb-4 antialiased'>
            (Frontend Developer)
          </h3>
          <p className='text-center text-gray-400 font-semibold md:hidden antialiased'>
            JavaScript | ReactJs | NextJs | Html | CSS | NodeJs | ExpressJs
        ...
        <div className='flex justify-center items-center mt-28 md:mt-8'>
            <div className={Classes.homeSocial}>
              <a className='ml-8'>
                {SvgComponents.linkedIn}
              </a>
              <a className='mr-8'>
                {SvgComponents.github}
              </a>
            </div>
        </div>
        </div>
        <div>
          <p className='p-8 text-center text-gray-500 font-bold hidden md:block'>
